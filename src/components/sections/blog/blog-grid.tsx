...
const BlogGrid = () => {
  ...
  return (
    <div className="flex justify-center mb-16">
      <div
        className="grid gap-[0.2rem] md:gap-[0.8rem] flex-col justify-center items-center grid-cols-[1fr_1fr_1fr] md:grid-cols-[repeat(auto-fill,minmax(250px,1fr))] w-[min(100%,75rem)] md:w-[min(90%,72rem)] blog_grid"
        style={{
          gridAutoRows: "230px",
        }}
      >
